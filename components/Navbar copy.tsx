...
// // import usaFlag from "@/public/united-states-flag.svg"
...
//       <div ref={animationParent} className=" flex justify-between py-4 px-4 items-center bg-nav-transparent text-blue-default rounded-full">
...
//                     {data.label}
//                     {data.children && (
//                       <IoIosArrowDown className="rotate-180 group-hover:rotate-0 transition-all ml-1" />
//                     )}
//                   </span>
//                 </p>
...
//             </Link>
//           </div>
//           <RiMenu3Line  onClick={openSideMenu} className="cursor-pointer text-4xl xl:hidden " />
//         </div>
//       </div>
//     </div>
//   );
...
//           <div className="flex flex-col items-start text-lg mr-2 ">
//             {navItem.map((data, i) => (
...
//               {data.children && (
//                 <IoIosArrowDown
//                   className={`text-sm transition ${isItemOpen && "rotate-180"}`}
//                 />
//               )}
//             </span>
//           </p>
